...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "InstaGig turns freelance work into beautifully designed invoices, auto-reminders, and same-day payments." },
      { property: "og:title", content: "InstaGig — Invoices that get paid." },
      { property: "og:description", content: "InstaGig turns freelance work into beautifully designed invoices, auto-reminders, and same-day payments." },
